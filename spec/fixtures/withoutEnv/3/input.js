...
const VacancyBlock = Components.build({
    create(element, { currentEmployerId, trl, siteId }) {
        ...
        async function applyFilter(filter) {
            try {
                ...
                const { data } = await axios.get('/shards/employerview/vacancies_groups', {
                    params: { ...filter, currentEmployerId, siteId },
                });
        ...
        const publicInterface = {
            ...
            groupByRegion() {
                currentFilters = {};
                return applyFilter({ groupByRegion: true });
            },
        };
